...
for i = 1:1:59
    ...
    e_01 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity01(i,1));
    ...
    e_1 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity1(i,1));
    ...
    e_5 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity5(i,1));
    ...
    dpdT_8 = getdpdT(PRDensity8(i,1),R,M,b,daaldT);
    
    dpdrho_8 = getdpdrho(PRDensity8(i,1),R,M,b,T,a,alpha);
    
    Cv_8 = getCv(PRDensity8(i,1),Cv_0,d2aaldT,M,b,T);
    
    Cp_8 = getCp(PRDensity8(i,1),Cv_8,T,dpdT_8,dpdrho_8);
    ...
    e_8 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity8(i,1));
    
    h_8=geth(e_8,8E6,PRDensity8(i,1));
    
    h_8_list(i,1)=h_8;

    %% Cp_7 calculation
    
    dpdT_7 = getdpdT(PRDensity7(i,1),R,M,b,daaldT);
    
    dpdrho_7 = getdpdrho(PRDensity7(i,1),R,M,b,T,a,alpha);
    
    Cv_7 = getCv(PRDensity7(i,1),Cv_0,d2aaldT,M,b,T);
    
    Cp_7 = getCp(PRDensity7(i,1),Cv_7,T,dpdT_7,dpdrho_7);
    ...
    e_7 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity7(i,1));
    
    h_7=geth(e_7,7E6,PRDensity7(i,1));
    ...
    e_10 = gete(e_0(i),T,b,M,daaldT,a,alpha,PRDensity10(i,1));
