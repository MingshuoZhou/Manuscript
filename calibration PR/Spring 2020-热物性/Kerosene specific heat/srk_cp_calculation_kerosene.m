...
R = 8.31446;%J/K*mol
M = 130.216/1000;  %moleculor mass 129.72 kg/mol
T = 300; %k
...
% h_50_list = zeros(171,1);
 ...
 for i = 1:1:101
    ...
    for j =1:1:3
        for k=1:1:3
            aalpha = aalpha + X(j)*X(k)*sqrt(a(j)*a(k)*Alpha(j)*Alpha(k))*0.87;
        end
    end
...
%        
     ...
     dpdrho_3 = getdpdrho(SRKDensity3(i,1),R,M,b,T,aalpha);
    
     Cv_3 = getCv(SRKDensity3(i,1),Cv_0(i,1),d2aaldT2,M,b,T);                                                     
...
%     h_3_list(i,1)=h_3;
    ...
    dpdrho_6 = getdpdrho(SRKDensity6(i,1),R,M,b,T,aalpha);
    
    Cv_6 = getCv(SRKDensity6(i,1),Cv_0(i,1),d2aaldT2,M,b,T);
...
%     h_6_list(i,1)=h_6;
    ...
    dpdrho_12 = getdpdrho(SRKDensity12(i,1),R,M,b,T,aalpha);
    
    Cv_12 = getCv(SRKDensity12(i,1),Cv_0(i,1),d2aaldT2,M,b,T);
...
%     h_12_list(i,1)=h_12;
    ...
    dpdrho_25 = getdpdrho(SRKDensity25(i,1),R,M,b,T,aalpha);
    
    Cv_25 = getCv(SRKDensity25(i,1),Cv_0(i,1),d2aaldT2,M,b,T);
...
%     h_25_list(i,1)=h_25;
    ...
    dpdrho_50 = getdpdrho(SRKDensity50(i,1),R,M,b,T,aalpha);
    
    Cv_50 = getCv(SRKDensity50(i,1),Cv_0(i,1),d2aaldT2,M,b,T);
