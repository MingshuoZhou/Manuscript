%SRK cp calculation for kerosene
clear all
clc
load SRK_Kerosene_Cpdata.mat
%% for decane
Tc_d = 617.7; %K
rho_d = 233; %kg/m^3
Pc_d = 2.103E6; %Pa
...
%        
     ...
     dpdT_3 = getdpdT(SRKDensity3(i,1),R,M,bmix,daaldT);
     
     dpdrho_3 = getdpdrho(SRKDensity3(i,1),R,M,bmix,T,aalpha);
    
     Cv_3 = getCv(SRKDensity3(i,1),Cv_0(i,1),d2aaldT2,M,bmix,T);                                                     
    ...
    e_3 = gete(e_0mix,T,bmix,M,daaldT,aalpha,SRKDensity3(i,1));
    ...
    dpdT_6 = getdpdT(SRKDensity6(i,1),R,M,bmix,daaldT);
    
    dpdrho_6 = getdpdrho(SRKDensity6(i,1),R,M,bmix,T,aalpha);
    
    Cv_6 = getCv(SRKDensity6(i,1),Cv_0(i,1),d2aaldT2,M,bmix,T);
    ...
    e_6 = gete(e_0mix,T,bmix,M,daaldT,aalpha,SRKDensity6(i,1));
    ...
    dpdT_12 = getdpdT(SRKDensity12(i,1),R,M,bmix,daaldT);
    
    dpdrho_12 = getdpdrho(SRKDensity12(i,1),R,M,bmix,T,aalpha);
    
    Cv_12 = getCv(SRKDensity12(i,1),Cv_0(i,1),d2aaldT2,M,bmix,T);
    ...
    e_12 = gete(e_0mix,T,bmix,M,daaldT,aalpha,SRKDensity12(i,1));
    ...
    dpdT_25 = getdpdT(SRKDensity25(i,1),R,M,bmix,daaldT);
    
    dpdrho_25 = getdpdrho(SRKDensity25(i,1),R,M,bmix,T,aalpha);
    
    Cv_25 = getCv(SRKDensity25(i,1),Cv_0(i,1),d2aaldT2,M,bmix,T);
    ...
    e_25 = gete(e_0mix,T,bmix,M,daaldT,aalpha,SRKDensity25(i,1));
    ...
    dpdT_50 = getdpdT(SRKDensity50(i,1),R,M,bmix,daaldT);
    
    dpdrho_50 = getdpdrho(SRKDensity50(i,1),R,M,bmix,T,aalpha);
    
    Cv_50 = getCv(SRKDensity50(i,1),Cv_0(i,1),d2aaldT2,M,bmix,T);
    ...
    e_50 = gete(e_0mix,T,bmix,M,daaldT,aalpha,SRKDensity50(i,1));
...
dpdrho = M*R*T/(M-b*rho)^2-aalpha*rho*(2*M+b*rho)/(M*(M+b*rho)^2);%partical derivative p to Rho;
end
