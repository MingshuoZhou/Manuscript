...
clc
clear all
load oxygen_sat_alpha_data.mat
...
for i = 1:1:50
    ...
    % alpha_liq
A = (a*alpha_SRK_liq(i)*P(i))/(R^2*T^2);

% % alpha_vap
% A = (a*alpha_SRK_vap(i)*P(i))/(R^2*T^2);
