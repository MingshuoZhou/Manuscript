...
% plot(1-sqrt(Tr_list),sqrt(alpha_PR_liq),'h','MarkerSize',8,'MarkerFaceColor','r','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_PT_liq),'h','MarkerSize',8,'MarkerFaceColor','g','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_SRK_liq),'h','MarkerSize',8,'MarkerFaceColor','m','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_PR_vap),'^','MarkerSize',8,'MarkerFaceColor','r','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_PT_vap),'^','MarkerSize',8,'MarkerFaceColor','g','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_SRK_vap),'^','MarkerSize',8,'MarkerFaceColor','m','LineWidth',1.2)
% plot(1-sqrt(Tr_list),sqrt(alpha_soave_PR),'r','LineWidth',2)
% plot(1-sqrt(Tr_list),sqrt(alpha_soave_SRK),'g','LineWidth',2)
% plot(1-sqrt(Tr_list),sqrt(alpha_Gasem),'b','LineWidth',2)
