clear 
clc
load methane_rho_different_pressure_data.mat
%PR Decane
...
hold off
legend('SRK NIST P0.1','SRK NIST P0.3','SRK NIST P0.5','SRK NIST P1','SRK NIST P3','SRK NIST P5','SRK NIST P10','Soave PR','Gasem','Twu')
xlabel('Tr')
ylabel('Alpha')
title('SRK EoS Alpha functions value comparison for methane')
