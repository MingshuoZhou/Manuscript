clear 
clc
load CO2_rho_different_pressure_data.mat
%PR Decane
P = [0.1E6,0.3E6,0.5E6,1E6,3E6,5E6,10E6]; %pa
omega = 0.239; %Acentric factor
Tc = 304.1; %K
Pc = 7830000; %Pa
R = 8.31446 %J/K*mol
b = 0.07780*(R*Tc/Pc);
...
hold off
legend('PR NIST P0.1','PR NIST P0.3','PR NIST P0.5','PR NIST P1','PR NIST P3','PR NIST P5','PR NIST P10','Soave PR','Gasem','Twu')
xlabel('Tr)')
ylabel('Alpha')
title('PR EoS Alpha functions value comparison for carbon dioxide')