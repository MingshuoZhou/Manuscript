clear 
clc
load ammonia_sat_data.mat
%alpha PR & SRK for water
P = P*10^6;
...
hold off
legend('PR NIST liq','PT NIST liq','SRK NIST liq','PR NIST vap','PT NIST vap','SRK NIST vap','Soave PR')
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for ammonia')
% axis([0.6,1,0.8,2.4])