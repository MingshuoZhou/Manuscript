clear 
clc
load pentafluoropropane_sat_data.mat
%alpha PR & SRK for pentafluoropropane
P = P*10^6;
omega = 0.3724; %Acentric factor
Tc = 427.2; %K
Pc = 3640000; %Pa
R = 8.31446 %J/K*mol
Zc = 0.266;
...
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for pentafluoropropane')
% axis([0.6,1,0.8,2.4])