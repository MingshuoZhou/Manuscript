clear 
clc
load 1112tetrafluoroethane_sat_data.mat
%alpha PR & SRK for 1112_tetrafluoroethane
P = P*10^6;
omega = 0.327; %Acentric factor
Tc = 374.21; %K
Pc = 4059280; %Pa
R = 8.31446 %J/K*mol
Zc = 0.259;
...
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for 1112 tetrafluoroethane')
% axis([0.6,1,0.8,2.4])