clear 
clc
load difluoroethane_sat_data.mat
%alpha PR & SRK for difluoroethane
P = P*10^6;
omega = 0.275; %Acentric factor
Tc = 386.7; %K
Pc = 4500000; %Pa
R = 8.31446 %J/K*mol
Zc = 0.252;
...
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for 1112 difluoroethane')
% axis([0.6,1,0.8,2.4])