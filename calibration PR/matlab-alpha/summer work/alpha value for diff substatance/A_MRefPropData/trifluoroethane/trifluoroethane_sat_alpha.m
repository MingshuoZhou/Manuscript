clear 
clc
load trifluoroethane_sat_data.mat
%alpha PR & SRK for trifluoroethane
P = P*10^6;
omega = 0.2615; %Acentric factor
Tc = 346.3; %K
Pc = 4500000; %Pa
R = 8.31446 %J/K*mol
Zc = 0.255;
...
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for 1112 trifluoroethane')
% axis([0.6,1,0.8,2.4])