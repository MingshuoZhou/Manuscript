clear 
clc
load tetrafluoroethane_sat_data.mat
%alpha PR & SRK for 2_chloro_1112_tetrafluoroethane
P = P*10^6;
omega = 0.288; %Acentric factor
Tc = 395.425; %K
Pc = 3624296; %Pa
R = 8.31446 %J/K*mol
Zc = 0.271;
...
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Pr for 2 chloro 1112 tetrafluoroethane')
% axis([0.6,1,0.8,2.4])