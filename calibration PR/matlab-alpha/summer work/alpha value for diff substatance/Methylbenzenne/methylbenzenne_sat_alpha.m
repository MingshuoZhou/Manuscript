clear 
clc
load methylbenzenne_sat_data.mat
%alpha PR & SRK for methylbenzenne
P = P*10^6;
omega = 0.266; %Acentric factor
Tc = 591.75; %K
Pc = 4126300; %Pa
R = 8.31446 %J/K*mol
Zc = 0.264;
...
hold off
legend('PR NIST liq','SRK NIST liq','PR NIST vap','SRK NIST vap','Soave PR')
xlabel('Tr')
ylabel('\alpha')
title('EoS Alpha functions value vs Tr for 2-Methylpropane')